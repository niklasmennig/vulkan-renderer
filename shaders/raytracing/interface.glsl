...
#define DESCRIPTOR_BINDING_RESTIR_INITIAL_SAMPLES 4
#define DESCRIPTOR_BINDING_RESTIR_TEMPORAL_RESERVOIR 5
#define DESCRIPTOR_BINDING_RESTIR_SPATIAL_RESERVOIR 6
